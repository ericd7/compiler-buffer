 ...
 *  Purpose:This is the main program for Assignment #1, CST8152, Fall 2013
 *  Version; 1.13.2
 ...
 * The define does not have any effect in Borland 5.02 or other compiler projects.
 */
...
/* set a mark */
  b_setmark(ptr_Buffer,b_getsize(ptr_Buffer));
